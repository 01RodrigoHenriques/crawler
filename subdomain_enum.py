    ...
    def _load_wordlist(self) -> List[str]:
        ...
        if not subdomains:
            subdomains = [
                ...
                "blog", "shop", "app", "mobile", "secure", "portal", "webmail",
                "remote", "vpn", "cloud", "backup", "git", "svn", "jenkins", "ci",
                "db", "database", "mysql", "postgres", "redis", "rabbitmq",
                "monitor", "monitoring", "status", "health", "swagger", "docs",
                "cdn", "static", "media", "assets", "image", "images", "video",
                "download", "upload", "files", "drive", "box", "dropbox",
                "mail", "email", "smtp", "pop", "imap", "calendar", "contacts",
                "chat", "slack", "teams", "zoom", "meet", "call", "voice",
                "pay", "payment", "billing", "invoice", "receipt", "order",
                "analytics", "metrics", "stats", "logs", "syslog", "debug",
                "internal", "intranet", "corporate", "office", "hr", "employee",
                "dashboard", "admin-panel", "cpanel", "whm", "phpmyadmin",
            ]
